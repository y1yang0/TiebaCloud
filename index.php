        	...
        	if($re = @mysql_fetch_array($res))
        	{
        		if($re['baidu_id'] == NULL)
        		{
        			$info =
				          ...
				          <strong>注意:</strong> 你还没有绑定账号，请将你的百度账号cookie粘贴至下面输入框
				          </div>
						  ...
						  <input type="text" name="cookie" id="cookie" class="form-control" placeholder="输入cookie,通常格式是 BDUSS=... ">
						   ...
						   <button class="btn btn-default" type="submit" name="bind">Go!</button>
						   </span>
						   </div>
						  </div></form>';
        		}else{
	        		$info = '<div class="row" style="margin:0 auto;">
						  <div class="col-xs-6 col-md-3">
						    <a href="#" class="thumbnail" data-toggle="tooltip" data-placement="left" title="欢迎使用贴吧云。">
						      <img src="'.$re['avastar'].' alt="...">
						    </a>
						  </div>
						<p>欢迎，<strong>'.$re['baidu_id'].'</strong></p><br><p>当你看到这个页面就意味着云签到开始为你服务了。</p></div>';
        		}
        	}else{
        		$info =
		           '<form action="./lib/bind.php" method="post"><div class="alert alert-warning alert-dismissible" role="alert">
...
<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      <div class="modal-header"><h1 class="text-center">贴吧云 - v1.0</h1>	</div>
        <?php echo $info;?>
      </div>
